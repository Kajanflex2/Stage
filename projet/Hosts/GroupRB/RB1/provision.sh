...
echo "hostname RB1" >> /etc/frr/vtysh.conf

echo " 
!
router bgp 65300
 bgp router-id 11.65.30.2
 no bgp ebgp-requires-policy
 neighbor 11.10.1.1 remote-as 65100
 neighbor 30.10.1.1 remote-as 65300
 neighbor 30.10.2.2 remote-as 65300
 !
 address-family ipv4 unicast
  distance bgp 20 200 200
  neighbor 30.10.1.1 next-hop-self
  neighbor 30.10.2.2 next-hop-self
 exit-address-family
exit
!
router ospf
 ospf router-id 30.1.2.3
